      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">CV</li>
             <li class="nav-item">
                <a href="{{route('cvs.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon text-info"></i>
                  <p>Projects</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('cvs.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon text-info"></i>
                  <p>Project Add</p>
                </a>
              </li>
          ...
          <li class="nav-header">ENTREPRISE</li>
          </li>
              <li class="nav-item">
          ...
          @if(Auth::user()->type == 'entreprise'  || Auth::user()->type == 'admin')
            <li class="nav-item">
              <a href="{{url('/listcv')}}" class="nav-link">
                <i class="far fa-circle nav-icon text-info"></i>
                <p class="text">List de CV</p>
              </a>
            </li>
          @endif
          @if (Auth::user()->type == 'emploi' || Auth::user()->type == 'admin')
          <li class="nav-item">
            <a href="{{route('listentreprise')}}" class="nav-link">
              <i class="far fa-circle nav-icon text-info"></i>
              <p class="text">List de entreprise</p>
            </a>
          </li>
          @endif
