...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control @error('telephone') is-invalid @enderror" name="telephone" placeholder="Telephone" value="{{old('telephone')}}">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <select id="inputStatus" name="type" class="form-control custom-select @error('type') is-invalid @enderror">
                <option disabled {{ old('type') ? '' : 'selected' }}>Select one</option>
